"""
Django settings for bidy project.

Generated by 'djangocms' command using django CMS 4.1.2 and Django 5.0.7.
...
SECRET_KEY = 'django-insecure-9lnt00kp54)x$g4)q-%r$qf=&(n_bfd@nj)dt%*rpl0gf4t1fc'
...
ROOT_URLCONF = 'bidy.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "bidy", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'bidy.wsgi.application'
...
CMS_TEMPLATES = (
    ("minimal.html", _("Minimal template")),
